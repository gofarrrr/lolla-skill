...
The separate user-values/priorities lane may continue only as docs/eval work
until a later implementation gate is approved.
```
...
- [ ] Behavioral risk-mode enforcement; PR36 is design-only, PR37 is fixture
  ...
  plans a human values/priorities worksheet, and PR50 only adds
...
- [ ] First-class user-values/priorities extraction or offline report; PR34 is
  design-only, PR49 is worksheet planning only, and PR50 is fixture-only.
...
2. **User-values/priorities fixture review, worksheet, or report.** PR34
   designs the signal, PR49 plans the human worksheet, and PR50 adds
   paraphrase-only fixtures. The next conservative slice is human/product
   review of those fixtures before any exporter or extraction.
