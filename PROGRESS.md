...
- [ ] Behavioral risk-mode enforcement; PR36 is design-only, PR37 is fixture
  ...
  worksheet fixtures, and PR51 only reviews those fixtures.
...
- [ ] First-class user-values/priorities extraction or offline report; PR34 is
  design-only, PR49 is worksheet planning only, PR50 is fixture-only, and PR51
  is fixture-review-only.
...
2. **User-values/priorities blank worksheet/export, then pilot decision.** PR34
   designs the signal, PR49 plans the human worksheet, PR50 adds
   paraphrase-only fixtures, and PR51 reviews those fixtures. The next
   conservative slice is blank worksheet/export structure before any populated
   extraction, automatic label, runtime integration, or judge.
