...
def build_enrichment_coverage_audit(
    ...
    *,
    ...
    return {
        ...
        "reviewed_source_custody_model_count": len(source_custody_model_ids & runtime_model_ids),
        "runtime_model_ids_missing_reviewed_source_custody_count": len(missing_source_custody),
        "runtime_model_ids_missing_v4": missing_v4,
        "runtime_model_ids_missing_reviewed_source_custody": missing_source_custody,
