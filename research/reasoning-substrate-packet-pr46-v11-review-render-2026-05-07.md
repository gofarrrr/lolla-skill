...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `cognitive-gaps-assessment.missing-reality-gap-audit` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `critical-thinking.claim-evidence-assumption-check` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `counterfactual-reasoning.plausible-alternative-branch-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `metacognitive-questioning.process-inspection-next-question-gate` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `reasoning-mode-router.context-driven-mode-selection-check` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `reframing-perspective.decision-variable-reframe-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `theory-induced-blindness.favored-framework-blindness-check` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `einstellung-effect.familiar-solution-lock-in-interrupt` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `dialectical-reasoning.bounded-antithesis-synthesis-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `bias-blind-spot.self-bias-accountability-check` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `false-precision-avoidance.decision-relevant-precision-boundary` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `wysiati.missing-evidence-denominator-audit` (supported; high)
