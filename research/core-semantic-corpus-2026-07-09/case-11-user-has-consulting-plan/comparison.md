...
| mean span repeatability | 0.423 | 0.952 |
| mean label repeatability | 0.423 | 0.952 |
...
| shadow | `assistant_stance_events` | [5, 5, 5] | 1.000 | 1.000 |
| shadow | `dropped_thread_events` | [1, 1, 1] | 1.000 | 1.000 |
| shadow | `evidence_boundary_events` | [0, 0, 0] | 1.000 | 1.000 |
| shadow | `live_constraint_events` | [5, 4, 4] | 0.667 | 0.667 |
