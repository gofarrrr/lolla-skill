...
| mean span repeatability | 0.425 | 0.402 |
| mean label repeatability | 0.425 | 0.388 |
...
| shadow | `assistant_stance_events` | [7, 6, 7] | 0.630 | 0.533 |
| shadow | `dropped_thread_events` | [1, 1, 1] | 0.333 | 0.333 |
| shadow | `evidence_boundary_events` | [3, 3, 3] | 0.133 | 0.133 |
| shadow | `live_constraint_events` | [5, 5, 5] | 0.667 | 0.667 |
| shadow | `option_events` | [4, 4, 4] | 0.600 | 0.600 |
| shadow | `question_events` | [2, 2, 2] | 0.222 | 0.222 |
| shadow | `user_pressure_events` | [5, 5, 4] | 0.228 | 0.228 |
...
Never source-grounded: constraint.spouse_primary_earner, drop.expected_value_argument, pressure.family_joint_decision, question.current_due_diligence, stance.final_conditional_choice
