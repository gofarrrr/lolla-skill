...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `nash-equilibrium.stable-best-response-map` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `prisoners-dilemma.defection-incentive-reframe-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `active-listening.hidden-disagreement-diagnostic-loop` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `constructive-feedback-models.specific-standard-correction` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `feedback-models-sbi.situation-impact-invitation-structure` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `analogies-and-metaphors.structural-fit-transfer-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `natural-selection-analogy.variation-selection-retention-loop` (supported; high)
