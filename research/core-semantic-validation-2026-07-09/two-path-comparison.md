...
| --- | ---: | ---: |
| repeated runs | 3 | 3 |
| exact-span gold recall | 0.000 | 0.778 |
| mean span repeatability | 0.460 | 0.865 |
| mean label repeatability | 0.460 | 0.827 |
...
| shadow | `assistant_stance_events` | [4, 4, 4] | 1.000 | 0.733 |
| shadow | `dropped_thread_events` | [2, 1, 2] | 0.667 | 0.667 |
| shadow | `evidence_boundary_events` | [3, 2, 3] | 0.611 | 0.611 |
| shadow | `live_constraint_events` | [5, 5, 5] | 1.000 | 1.000 |
| shadow | `option_events` | [2, 2, 3] | 0.778 | 0.778 |
| shadow | `question_events` | [2, 2, 2] | 1.000 | 1.000 |
| shadow | `user_pressure_events` | [4, 4, 4] | 1.000 | 1.000 |
...
Never source-grounded: drop.evidence_question_not_answered, pressure.board_brand_excitement, pressure.weak_email_evidence
