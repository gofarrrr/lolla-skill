...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `batna.credible-walk-away-alternative-test` (supported; medium)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `red-queen-effect.relative-position-adaptation-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `delays.lagged-feedback-timing-gate` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `obligations-controls-mapping.obligation-to-control-trace` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `jobs-to-be-done.real-progress-job-discovery` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `lock-in.reversal-cost-dependency-audit` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `path-dependence.installed-dependency-unwind-map` (supported; high)
