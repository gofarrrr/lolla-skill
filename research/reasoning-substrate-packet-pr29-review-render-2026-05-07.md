...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `falsifiability.disconfirming-reversal-gate` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `probabilistic-thinking.range-and-sensitivity-decision-gate` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `step-back.reorientation-before-execution-gate` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `constraints.scope-boundary-decision-filter` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `chain-of-verification.make-or-break-premise-audit` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `confirmation-bias.disconfirming-evidence-equality-check` (supported; high)
