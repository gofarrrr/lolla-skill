...
Generated: 2026-04-26T13:59:57Z
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `marcus-equity-prb-v3-on` | 3 | 0.05 | 0.79 | 0.29 | 0.32 | 0.13 | 0.06 | 0.13 | 100% (n=1) | 503736 | `inconclusive_widen_n_or_cases` |
| `mid-level-consultant-decides-prb-v3-on` | 3 | 0.00 | 0.79 | 0.28 | 0.31 | 0.18 | 0.22 | 0.18 | 20% (n=1) | 363402 | `inconclusive_widen_n_or_cases` |
| `mother-deciding-address-year-prb-v3-on` | 3 | 0.06 | 0.77 | 0.40 | 0.42 | 0.26 | 0.13 | 0.26 | 60% (n=1) | 274771 | `inconclusive_widen_n_or_cases` |
| `third-year-phd-student-prb-v3-on` | 3 | 0.00 | 0.77 | 0.48 | 0.71 | 0.51 | 0.33 | 0.51 | 80% (n=1) | 500161 | `inconclusive_widen_n_or_cases` |

## Sources

- `marcus-equity-prb-v3-on` (on): N=3
- `mid-level-consultant-decides-prb-v3-on` (on): N=3
- `third-year-phd-student-prb-v3-on` (on): N=3
- `mother-deciding-address-year-prb-v3-on` (on): N=3
