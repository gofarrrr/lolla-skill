...
| --- | ---: | ---: |
| repeated runs | 3 | 3 |
| exact-span gold recall | 0.125 | 0.667 |
| mean span repeatability | 0.209 | 0.608 |
| mean label repeatability | 0.209 | 0.576 |
...
| shadow | `assistant_stance_events` | [4, 4, 5] | 0.867 | 0.867 |
| shadow | `dropped_thread_events` | [1, 1, 1] | 1.000 | 1.000 |
| shadow | `evidence_boundary_events` | [2, 2, 2] | 0.556 | 0.333 |
| shadow | `live_constraint_events` | [4, 5, 5] | 0.656 | 0.656 |
| shadow | `option_events` | [3, 3, 3] | 0.067 | 0.067 |
| shadow | `question_events` | [2, 3, 2] | 0.778 | 0.778 |
| shadow | `user_pressure_events` | [3, 2, 3] | 0.333 | 0.333 |
...
Stable across all repeats: boundary.sensible_or_scared, pressure.insurance_requirement, question.current_middle_path, stance.need_state_affordability

Never source-grounded: drop.regret_argument, question.initial_raise_or_walk
