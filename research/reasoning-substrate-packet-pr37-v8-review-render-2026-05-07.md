...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `non-violent-communication.needs-observations-request-clarifier` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `emotional-intelligence.emotion-evidence-landing-check` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `understanding-motivations.hidden-driver-hypothesis-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `boundaries.scope-ownership-decision-rights-filter` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `authenticity.congruence-candor-substance-check` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `hanlons-razor.non-malice-diagnostic-delay` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `reciprocity-principle.costly-value-trust-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `persuasion-principles.substance-preserving-adoption-design` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `international-negotiation-and-diplomacy-models.substance-signaling-settlement-map` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `signaling.costly-proof-of-intent-test` (supported; high)
