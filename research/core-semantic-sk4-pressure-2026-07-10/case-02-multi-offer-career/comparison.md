...
| mean span repeatability | 0.425 | 0.552 |
| mean label repeatability | 0.425 | 0.526 |
...
| shadow | `assistant_stance_events` | [6, 6, 6] | 0.344 | 0.344 |
| shadow | `dropped_thread_events` | [1, 1, 1] | 1.000 | 1.000 |
| shadow | `evidence_boundary_events` | [5, 5, 5] | 0.508 | 0.389 |
| shadow | `live_constraint_events` | [6, 4, 7] | 0.334 | 0.334 |
| shadow | `option_events` | [4, 4, 4] | 1.000 | 1.000 |
| shadow | `question_events` | [5, 6, 8] | 0.371 | 0.371 |
| shadow | `user_pressure_events` | [8, 8, 8] | 0.305 | 0.247 |
...
Stable across all repeats: question.current_due_diligence, stance.financial_reframe

Never source-grounded: boundary.spouse_yes_may_not_be_real, drop.expected_value_argument, stance.final_conditional_choice
