...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `risk-vs-uncertainty.commitment-sizing-under-unknowns` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `switching-costs.reversibility-decay-exit-plan` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `redundancy.single-point-failure-backup-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `regulatory-horizon-scanning.weak-signal-response-trigger` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `cybersecurity-thinking-models.adversarial-failure-chain-map` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `non-linear-dynamics.feedback-threshold-local-optimization-check` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `tipping-points.threshold-prerequisite-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `butterfly-effect.cascade-path-trace` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `chaos-theory.resilience-over-precision-bet-sizing` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `combinatorial-effects.make-or-break-interaction-map` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `critical-mass.viability-threshold-density-test` (supported; high)
...
- Reviewed handoff signals:
  - reviewed_affordance_cards:
    - `prospect-theory.loss-frame-decision-quality-check` (supported; high)
