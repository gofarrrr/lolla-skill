#!/usr/bin/env python3
"""Compile a pre-written source-review target through role-first v2.1."""
...
def build(output: Path) -> dict:
    ...
    for role in ROLE_ORDER:
        ...
        roles[role] = compile_position_role_response_v21(
            ...
            producer_id="pre-execution-v21-target",
        )
    ...
    fixture = {
        "schema_version": "lolla.reasoning_process_position_role_first_v21_target_fixture.v1",
    ...
    report = {
        "schema_version": "lolla.reasoning_process_position_role_first_v21_target_report.v1",
