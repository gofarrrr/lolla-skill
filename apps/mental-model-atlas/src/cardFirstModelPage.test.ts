...
describe("card-first model page contract", () => {
  ...
  it.each([
    ...
    ["reader chapter range", (page: any) => { page.source_card.reader_projection.chapters[2].end_line = 73; }],
    ["reader source appendix", (page: any) => { page.source_card.reader_projection.source_appendix.start_line = 99; }],
    ["reader cue source", (page: any) => { page.source_card.reader_projection.orientation_cues[0].text = "invented orientation"; }],
    ["reader partition", (page: any) => { page.source_card.reader_projection.substantive_line_accounting.primary_learning_sequence.pop(); }],
