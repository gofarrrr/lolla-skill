...
from engine.system_b.frame_pressure import _parse_frame_extraction
...
def test_empty_evidence_quote_rejected():
    ...
    elements, dropped = _parse_frame_extraction(_make_raw(VALID_ELEMENT, bad), QUERY)
...
def test_dropped_elements_carry_element_text():
    ...
    _, dropped = _parse_frame_extraction(_make_raw(bad_ev, bad_pat), QUERY)
