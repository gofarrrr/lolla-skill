...
| [Decision Work Brief PRD](docs/conversation-understanding/decision-work-brief-prd-v0.md) | Product-facing target and PR113-PR145 delivery plan for the missing layer: a plain-language brief explaining the decision, what Lolla pressed on, what changed, what remains unresolved, and what the audit must not claim. |
