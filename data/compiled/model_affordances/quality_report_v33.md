# Model Affordance Quality Report v33
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `49`
  - `not_supported_by_source`: `428`
  - `source_too_thin`: `17`
...
| `inversion` | 3 | 2 | `high` | `inversion.obstacle-removal-before-added-force` |
...
| `second-order-thinking` | 1 | 2 | `high` | none |
...
- `what is the oneday answer` appears in `3` affordance(s): `optimization-theory.leverage-bounded-analysis`, `second-order-thinking.downstream-reversal-stress-test`, `step-back.reorientation-before-execution-gate`
...
Median affordance-level source quote length: `111` characters.
