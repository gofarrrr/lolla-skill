# Model Affordance Quality Report v54
...
- adaptation, agile-methodologies, algorithmic-thinking, auditability-traceability, authenticity, bias-blind-spot, boundaries, brainstorming, branch-solve-merge, causal-attribution-resistance, circle-of-competence, cognitive-biases, cognitive-gaps-assessment, combinatorial-effects, comparative-political-systems-analysis, complexity-bias-resistance, compounding, consulting-firms-methodology, creative-destruction, critical-mass, curiosity, cybersecurity-thinking-models, debugging-strategies, dialectical-reasoning, einstellung-effect, endowment-effect, extreme-performance-evaluation, gestalt-principles-of-perception, goal-setting, habit-formation, hanlons-razor, hindsight-bias, iteration, lateral-thinking, lean-startup-methodology, multicultural-team-dynamics, non-linear-dynamics, persistence-grit, peter-principle, power-laws, prospect-theory, rationalization, reframing-perspective, regret-theory, regulatory-horizon-scanning, scale-economies, self-control, self-determination-theory, simplification, specialization, supply-and-demand, synthesis-and-integration, system-1, tier-2-high-value, time-tested-validation, tipping-points, tradition-vs-innovation-balance, variation-and-selection, varied-practice-interleaving: `{'explicit': 4, 'not_supported_by_source': 2}`
...
- cognitive-dissonance, cross-cultural-communication-frameworks, emotional-intelligence, feedback-loops, redundancy, storytelling-frameworks, switching-costs: `{'explicit': 8, 'not_supported_by_source': 2}`
...
- cultural-dimensions-theory, dunning-kruger-effect, regression-to-the-mean: `{'explicit': 4, 'not_supported_by_source': 5}`
