# Model Affordance Quality Report v53
...
| `calculated-risk-taking` | 1 | 3 | `high` | none |
...
| `risk-assessment` | 1 | 4 | `high` | none |
| `risk-vs-uncertainty` | 1 | 3 | `high` | none |
...
- baseline-establishment, category-decisions, chaos-theory, divergent-vs-convergent-thinking, logical-fallacies, monte-carlo-methods, risk-vs-uncertainty, statistics-concepts, theory-induced-blindness: `{'explicit': 4, 'not_supported_by_source': 4}`
