# Model Affordance Quality Report v51
...
- adaptation, agile-methodologies, algorithmic-thinking, auditability-traceability, authenticity, bias-blind-spot, boundaries, brainstorming, branch-solve-merge, causal-attribution-resistance, circle-of-competence, cognitive-biases, cognitive-gaps-assessment, combinatorial-effects, comparative-political-systems-analysis, complexity-bias-resistance, compounding, consulting-firms-methodology, counterfactual-reasoning, creative-destruction, critical-mass, curiosity, cybersecurity-thinking-models, debugging-strategies, dialectical-reasoning, einstellung-effect, endowment-effect, extreme-performance-evaluation, gestalt-principles-of-perception, goal-setting, habit-formation, hanlons-razor, hindsight-bias, iteration, lateral-thinking, lean-startup-methodology, logical-fallacies, multicultural-team-dynamics, non-linear-dynamics, persistence-grit, peter-principle, power-laws, prospect-theory, rationalization, reframing-perspective, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, scale-economies, self-control, self-determination-theory, simplification, specialization, supply-and-demand, synthesis-and-integration, system-1, tier-2-high-value, time-tested-validation, tipping-points, tradition-vs-innovation-balance, variation-and-selection, varied-practice-interleaving, wysiati: `{'explicit': 4, 'not_supported_by_source': 2}`
...
- baseline-establishment, category-decisions, chaos-theory, divergent-vs-convergent-thinking, monte-carlo-methods, risk-vs-uncertainty, statistics-concepts, theory-induced-blindness: `{'explicit': 4, 'not_supported_by_source': 4}`
...
- association, scientific-method-evidence-testing, step-back: `{'explicit': 8, 'not_supported_by_source': 3}`
...
Median affordance-level source quote length: `105` characters.
