# Model Affordance Quality Report v9
...
- Contributing records: `110`
- Compiled affordances: `146`
- Compiled absence records: `205`
- Affordance count distribution per model:
  - `1` affordance(s): active-listening, adverse-selection, algorithmic-thinking, analogies-and-metaphors, anchoring, antifragility, auditability-traceability, authenticity, authority-bias, base-rates, baseline-establishment, batna, bottlenecks, boundaries, calculated-risk-taking, chain-of-verification, checklists, circle-of-control, commitment-bias, comparative-advantage, confirmation-bias, constraints, constructive-feedback-models, cross-cultural-communication-frameworks, debugging-strategies, delays, devops-and-continuous-integration, emotional-intelligence, expected-value, falsifiability, feedback-loops, feedback-models-sbi, first-principles-thinking, five-whys-method, flow, formal-reasoning, game-theory-payoffs, goal-setting, habit-formation, hanlons-razor, input-vs-output-goals, intellectual-humility, international-negotiation-and-diplomacy-models, iteration, jobs-to-be-done, johari-window, lean-startup-methodology, lindy-effect, lock-in, margin-of-safety, multi-criteria-decision-analysis, nash-equilibrium, natural-selection-analogy, non-violent-communication, obligations-controls-mapping, occams-razor, opportunity-cost, optimism-bias-and-planning-fallacy, pareto-principle, path-dependence, peer-review-your-perspectives, persuasion-principles, premortem, principal-agent-problem, prisoners-dilemma, probabilistic-thinking, reciprocity-principle, red-queen-effect, resilience, risk-assessment, root-cause-analysis, scientific-method-evidence-testing, second-order-thinking, signaling, six-thinking-hats, status-quo-bias, step-back, sunk-cost-fallacy, trade-offs, true-uncertainty-navigation, understanding-motivations, user-centered-design
...
- algorithmic-thinking, auditability-traceability, authenticity, baseline-establishment, bottlenecks, boundaries, debugging-strategies, feedback-loops, goal-setting, habit-formation, hanlons-razor, international-negotiation-and-diplomacy-models, iteration, lean-startup-methodology, persuasion-principles, reciprocity-principle, signaling, understanding-motivations: `{'explicit': 4, 'not_supported_by_source': 2}`
...
Median affordance-level source quote length: `128` characters.
