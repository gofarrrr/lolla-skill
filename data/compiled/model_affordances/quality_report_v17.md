# Model Affordance Quality Report v17
...
- Contributing records: `206`
- Compiled affordances: `242`
- Compiled absence records: `397`
- Affordance count distribution per model:
  - `1` affordance(s): abstraction, active-listening, adaptation, adverse-selection, algorithmic-thinking, analogies-and-metaphors, anchoring, antifragility, association, auditability-traceability, authenticity, authority-bias, base-rates, baseline-establishment, batna, bayesian, bias-blind-spot, blooms-taxonomy, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, calculated-risk-taking, category-decisions, chain-of-verification, chaos-theory, checklists, circle-of-control, cognitive-biases, cognitive-dissonance, cognitive-gaps-assessment, cognitive-load-theory, combinatorial-effects, commitment-bias, comparative-advantage, comparative-political-systems-analysis, compounding, confirmation-bias, conjunction-fallacy, constraints, constructive-feedback-models, consulting-firms-methodology, counterfactual-reasoning, creative-destruction, critical-mass, critical-thinking, cross-cultural-communication-frameworks, cultural-dimensions-theory, cultural-intelligence, curiosity, curse-of-knowledge, cybersecurity-thinking-models, data-science-reasoning-framework, debugging-strategies, delays, deliberate-practice, desirable-difficulties, devops-and-continuous-integration, dialectical-reasoning, divergent-vs-convergent-thinking, dunning-kruger-effect, einstellung-effect, elasticity, emotional-intelligence, evolutionary-pressure, expected-value, expertise-reversal-effect, extreme-performance-evaluation, false-precision-avoidance, falsifiability, feedback-loops, feedback-models-sbi, feynman-technique, first-principles-thinking, five-whys-method, flow, formal-reasoning, game-theory-payoffs, generation-effect, gestalt-principles-of-perception, goal-setting, growth-mindset, habit-formation, hanlons-razor, hindsight-bias, information-theory, input-vs-output-goals, intellectual-humility, internal-locus-of-control, international-negotiation-and-diplomacy-models, iteration, jobs-to-be-done, johari-window, lateral-thinking, lean-startup-methodology, learning-curve, liking-principle, lindy-effect, lock-in, margin-of-safety, markov-chains, mental-simulation, metacognitive-questioning, monte-carlo-methods, multi-criteria-decision-analysis, multicultural-team-dynamics, narratives, nash-equilibrium, natural-selection-analogy, non-linear-dynamics, non-violent-communication, obligations-controls-mapping, occams-razor, opportunity-cost, optimism-bias-and-planning-fallacy, pareto-principle, path-dependence, peer-review-your-perspectives, persistence-grit, persuasion-principles, peter-principle, power-laws, pre-suasion, premortem, price-discrimination, principal-agent-problem, prisoners-dilemma, probabilistic-thinking, prospect-theory, rationalization, reasoning-mode-router, reciprocity-principle, red-queen-effect, redundancy, reframing-perspective, regression-to-the-mean, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, resilience, risk-assessment, risk-vs-uncertainty, root-cause-analysis, scaffolding, scale-economies, schema-acquisition, scientific-method-evidence-testing, second-order-thinking, self-control, self-determination-theory, self-organization-and-emergent-order, signaling, simplification, six-thinking-hats, specialization, statistical-learning-theory, statistics-concepts, status-quo-bias, step-back, storytelling-frameworks, sunk-cost-fallacy, supply-and-demand, switching-costs, synthesis-and-integration, theory-induced-blindness, tipping-points, trade-offs, tradition-vs-innovation-balance, true-uncertainty-navigation, understanding-motivations, usability-heuristics, user-centered-design, user-experience-research-methods, variation-and-selection, varied-practice-interleaving, wysiati, zone-of-development
...
| `category-decisions` | 1 | 2 | `high` | none |
...
| `conjunction-fallacy` | 1 | 2 | `high` | none |
...
| `critical-thinking` | 1 | 2 | `high` | none |
...
| `information-theory` | 1 | 2 | `high` | none |
| `input-vs-output-goals` | 1 | 2 | `high` | none |
| `intellectual-humility` | 1 | 2 | `high` | none |
| `internal-locus-of-control` | 1 | 2 | `high` | none |
...
| `markov-chains` | 1 | 2 | `medium` | none |
| `mental-simulation` | 1 | 2 | `high` | none |
| `metacognitive-questioning` | 1 | 2 | `high` | none |
...
| `price-discrimination` | 1 | 2 | `medium` | none |
...
| `reasoning-mode-router` | 1 | 2 | `high` | none |
...
- abstraction, adaptation, algorithmic-thinking, association, auditability-traceability, authenticity, baseline-establishment, bayesian, bias-blind-spot, blooms-taxonomy, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, category-decisions, chaos-theory, cognitive-biases, cognitive-dissonance, cognitive-gaps-assessment, cognitive-load-theory, combinatorial-effects, comparative-political-systems-analysis, compounding, conjunction-fallacy, consulting-firms-methodology, counterfactual-reasoning, creative-destruction, critical-mass, critical-thinking, cultural-dimensions-theory, cultural-intelligence, curiosity, curse-of-knowledge, cybersecurity-thinking-models, data-science-reasoning-framework, debugging-strategies, deliberate-practice, desirable-difficulties, dialectical-reasoning, divergent-vs-convergent-thinking, dunning-kruger-effect, einstellung-effect, elasticity, evolutionary-pressure, expertise-reversal-effect, extreme-performance-evaluation, false-precision-avoidance, feedback-loops, feynman-technique, generation-effect, gestalt-principles-of-perception, goal-setting, growth-mindset, habit-formation, hanlons-razor, hindsight-bias, information-theory, internal-locus-of-control, international-negotiation-and-diplomacy-models, iteration, lateral-thinking, lean-startup-methodology, learning-curve, liking-principle, mental-simulation, metacognitive-questioning, monte-carlo-methods, multicultural-team-dynamics, narratives, non-linear-dynamics, persistence-grit, persuasion-principles, peter-principle, power-laws, pre-suasion, prospect-theory, rationalization, reasoning-mode-router, reciprocity-principle, redundancy, reframing-perspective, regression-to-the-mean, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, risk-vs-uncertainty, scaffolding, scale-economies, schema-acquisition, self-control, self-determination-theory, self-organization-and-emergent-order, signaling, simplification, specialization, statistical-learning-theory, statistics-concepts, storytelling-frameworks, supply-and-demand, switching-costs, synthesis-and-integration, theory-induced-blindness, tipping-points, tradition-vs-innovation-balance, understanding-motivations, usability-heuristics, user-experience-research-methods, variation-and-selection, varied-practice-interleaving, wysiati, zone-of-development: `{'explicit': 4, 'not_supported_by_source': 2}`
...
- devops-and-continuous-integration, markov-chains: `{'explicit': 3, 'not_supported_by_source': 2, 'review_note': 1}`
...
Median affordance-level source quote length: `115` characters.
...
- `storytelling-frameworks.structure-behavior-change-message`: shortest quote `31` chars across `3` quote(s)
...
- `metacognitive-questioning.process-inspection-next-question-gate`: shortest quote `43` chars across `3` quote(s)
...
- `reasoning-mode-router.context-driven-mode-selection-check`: shortest quote `44` chars across `3` quote(s)
...
- `markov-chains.state-transition-boundary-check`: shortest quote `59` chars across `3` quote(s)
...
- `critical-thinking.claim-evidence-assumption-check`: shortest quote `77` chars across `3` quote(s)
