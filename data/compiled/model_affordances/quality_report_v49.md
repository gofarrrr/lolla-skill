# Model Affordance Quality Report v49
...
- Compiled affordances: `293`
- Compiled absence records: `567`
- Affordance count distribution per model:
  ...
  - `2` affordance(s): abstraction, aleatory-epistemic-uncertainty-recognition, analogies-and-metaphors, association, black-swan-events, cognitive-dissonance, commitment-bias, confirmation-bias, constraints, correlation-vs-causation, cross-cultural-communication-frameworks, curse-of-knowledge, data-science-reasoning-framework, decision-trees, decomposition, emergence, emotional-intelligence, experimentation, expertise-reversal-effect, feedback-loops, incentives, law-of-large-numbers, learning-curve, lock-in, metacognitive-questioning, moral-hazard, nash-equilibrium, network-effects, optimization-theory, optionality, path-dependence, perceptual-learning, prioritization, psychological-safety, redundancy, signaling, social-proof, statistical-discipline, status-quo-bias, sunk-cost-fallacy, survivorship-bias, switching-costs, theory-of-constraints
