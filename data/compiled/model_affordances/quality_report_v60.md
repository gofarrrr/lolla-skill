# Model Affordance Quality Report v60
...
- baseline-establishment, chaos-theory, divergent-vs-convergent-thinking, logical-fallacies, monte-carlo-methods, statistics-concepts, theory-induced-blindness: `{'explicit': 4, 'not_supported_by_source': 4}`
- checklists, delays, formal-reasoning, jobs-to-be-done, natural-selection-analogy, obligations-controls-mapping, optimism-bias-and-planning-fallacy: `{'explicit': 6, 'not_supported_by_source': 2}`
...
- abstraction, curse-of-knowledge, lock-in, perceptual-learning: `{'explicit': 9, 'not_supported_by_source': 2}`
