# Model Affordance Quality Report v12
...
- Contributing records: `146`
- Compiled affordances: `182`
- Compiled absence records: `277`
- Affordance count distribution per model:
  - `1` affordance(s): abstraction, active-listening, adaptation, adverse-selection, algorithmic-thinking, analogies-and-metaphors, anchoring, antifragility, association, auditability-traceability, authenticity, authority-bias, base-rates, baseline-establishment, batna, bias-blind-spot, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, calculated-risk-taking, chain-of-verification, chaos-theory, checklists, circle-of-control, cognitive-gaps-assessment, combinatorial-effects, commitment-bias, comparative-advantage, confirmation-bias, constraints, constructive-feedback-models, counterfactual-reasoning, creative-destruction, critical-mass, critical-thinking, cross-cultural-communication-frameworks, curiosity, cybersecurity-thinking-models, debugging-strategies, delays, devops-and-continuous-integration, dialectical-reasoning, divergent-vs-convergent-thinking, einstellung-effect, emotional-intelligence, expected-value, false-precision-avoidance, falsifiability, feedback-loops, feedback-models-sbi, first-principles-thinking, five-whys-method, flow, formal-reasoning, game-theory-payoffs, goal-setting, habit-formation, hanlons-razor, input-vs-output-goals, intellectual-humility, international-negotiation-and-diplomacy-models, iteration, jobs-to-be-done, johari-window, lateral-thinking, lean-startup-methodology, lindy-effect, lock-in, margin-of-safety, mental-simulation, metacognitive-questioning, multi-criteria-decision-analysis, nash-equilibrium, natural-selection-analogy, non-linear-dynamics, non-violent-communication, obligations-controls-mapping, occams-razor, opportunity-cost, optimism-bias-and-planning-fallacy, pareto-principle, path-dependence, peer-review-your-perspectives, persuasion-principles, premortem, principal-agent-problem, prisoners-dilemma, probabilistic-thinking, prospect-theory, reasoning-mode-router, reciprocity-principle, red-queen-effect, redundancy, reframing-perspective, regulatory-horizon-scanning, resilience, risk-assessment, risk-vs-uncertainty, root-cause-analysis, scientific-method-evidence-testing, second-order-thinking, signaling, six-thinking-hats, status-quo-bias, step-back, sunk-cost-fallacy, switching-costs, synthesis-and-integration, theory-induced-blindness, tipping-points, trade-offs, true-uncertainty-navigation, understanding-motivations, user-centered-design, variation-and-selection, wysiati
...
- abstraction, adaptation, algorithmic-thinking, association, auditability-traceability, authenticity, baseline-establishment, bias-blind-spot, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, chaos-theory, cognitive-gaps-assessment, combinatorial-effects, counterfactual-reasoning, creative-destruction, critical-mass, critical-thinking, curiosity, cybersecurity-thinking-models, debugging-strategies, dialectical-reasoning, divergent-vs-convergent-thinking, einstellung-effect, false-precision-avoidance, feedback-loops, goal-setting, habit-formation, hanlons-razor, international-negotiation-and-diplomacy-models, iteration, lateral-thinking, lean-startup-methodology, mental-simulation, metacognitive-questioning, non-linear-dynamics, persuasion-principles, prospect-theory, reasoning-mode-router, reciprocity-principle, redundancy, reframing-perspective, regulatory-horizon-scanning, risk-vs-uncertainty, signaling, switching-costs, synthesis-and-integration, theory-induced-blindness, tipping-points, understanding-motivations, variation-and-selection, wysiati: `{'explicit': 4, 'not_supported_by_source': 2}`
...
Median affordance-level source quote length: `124` characters.
