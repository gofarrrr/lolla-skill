# Model Affordance Quality Report v30
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `48`
  - `not_supported_by_source`: `408`
  - `source_too_thin`: `17`
...
| `chain-of-verification` | 1 | 3 | `high` | none |
...
- chain-of-thought, meta-cognitive-reflection: `{'explicit': 4, 'not_supported_by_source': 8}`
- active-listening, constructive-feedback-models: `{'explicit': 6, 'not_supported_by_source': 3}`
- latticework-of-mental-models, metacognitive-questioning: `{'explicit': 7, 'not_supported_by_source': 2}`
