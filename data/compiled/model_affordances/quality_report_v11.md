# Model Affordance Quality Report v11
...
- Contributing records: `134`
- Compiled affordances: `170`
- Compiled absence records: `253`
- Affordance count distribution per model:
  - `1` affordance(s): active-listening, adverse-selection, algorithmic-thinking, analogies-and-metaphors, anchoring, antifragility, auditability-traceability, authenticity, authority-bias, base-rates, baseline-establishment, batna, bias-blind-spot, bottlenecks, boundaries, butterfly-effect, calculated-risk-taking, chain-of-verification, chaos-theory, checklists, circle-of-control, cognitive-gaps-assessment, combinatorial-effects, commitment-bias, comparative-advantage, confirmation-bias, constraints, constructive-feedback-models, counterfactual-reasoning, critical-mass, critical-thinking, cross-cultural-communication-frameworks, cybersecurity-thinking-models, debugging-strategies, delays, devops-and-continuous-integration, dialectical-reasoning, einstellung-effect, emotional-intelligence, expected-value, false-precision-avoidance, falsifiability, feedback-loops, feedback-models-sbi, first-principles-thinking, five-whys-method, flow, formal-reasoning, game-theory-payoffs, goal-setting, habit-formation, hanlons-razor, input-vs-output-goals, intellectual-humility, international-negotiation-and-diplomacy-models, iteration, jobs-to-be-done, johari-window, lean-startup-methodology, lindy-effect, lock-in, margin-of-safety, metacognitive-questioning, multi-criteria-decision-analysis, nash-equilibrium, natural-selection-analogy, non-linear-dynamics, non-violent-communication, obligations-controls-mapping, occams-razor, opportunity-cost, optimism-bias-and-planning-fallacy, pareto-principle, path-dependence, peer-review-your-perspectives, persuasion-principles, premortem, principal-agent-problem, prisoners-dilemma, probabilistic-thinking, prospect-theory, reasoning-mode-router, reciprocity-principle, red-queen-effect, redundancy, reframing-perspective, regulatory-horizon-scanning, resilience, risk-assessment, risk-vs-uncertainty, root-cause-analysis, scientific-method-evidence-testing, second-order-thinking, signaling, six-thinking-hats, status-quo-bias, step-back, sunk-cost-fallacy, switching-costs, theory-induced-blindness, tipping-points, trade-offs, true-uncertainty-navigation, understanding-motivations, user-centered-design, wysiati
...
- algorithmic-thinking, auditability-traceability, authenticity, baseline-establishment, bias-blind-spot, bottlenecks, boundaries, butterfly-effect, chaos-theory, cognitive-gaps-assessment, combinatorial-effects, counterfactual-reasoning, critical-mass, critical-thinking, cybersecurity-thinking-models, debugging-strategies, dialectical-reasoning, einstellung-effect, false-precision-avoidance, feedback-loops, goal-setting, habit-formation, hanlons-razor, international-negotiation-and-diplomacy-models, iteration, lean-startup-methodology, metacognitive-questioning, non-linear-dynamics, persuasion-principles, prospect-theory, reasoning-mode-router, reciprocity-principle, redundancy, reframing-perspective, regulatory-horizon-scanning, risk-vs-uncertainty, signaling, switching-costs, theory-induced-blindness, tipping-points, understanding-motivations, wysiati: `{'explicit': 4, 'not_supported_by_source': 2}`
...
Median affordance-level source quote length: `125` characters.
