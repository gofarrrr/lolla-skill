# Model Affordance Quality Report v55
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `65`
  - `not_supported_by_source`: `531`
  - `source_too_thin`: `17`
...
| `conjunction-fallacy` | 1 | 5 | `high` | none |
...
| `mental-models-of-reality` | 1 | 5 | `high` | none |
...
- baseline-establishment, category-decisions, chaos-theory, divergent-vs-convergent-thinking, logical-fallacies, monte-carlo-methods, statistics-concepts, theory-induced-blindness: `{'explicit': 4, 'not_supported_by_source': 4}`
...
- conjunction-fallacy, debugging-strategies, iteration: `{'explicit': 4, 'not_supported_by_source': 7}`
...
- meta-cognitive-reflection, risk-vs-uncertainty: `{'explicit': 4, 'not_supported_by_source': 8}`
