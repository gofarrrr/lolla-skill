# Model Affordance Quality Report v18
...
| `chain-of-thought` | 1 | 2 | `high` | none |
...
| `mental-models-of-reality` | 1 | 2 | `high` | none |
| `mental-simulation` | 1 | 2 | `high` | none |
| `meta-cognitive-reflection` | 1 | 2 | `high` | none |
...
| `scaffolding-educational` | 1 | 2 | `high` | none |
...
- abstraction, adaptation, agile-methodologies, algorithmic-thinking, association, auditability-traceability, authenticity, baseline-establishment, bayesian, bias-blind-spot, blooms-taxonomy, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, category-decisions, causal-attribution-resistance, chain-of-thought, chaos-theory, circle-of-competence, cognitive-biases, cognitive-dissonance, cognitive-gaps-assessment, cognitive-load-theory, combinatorial-effects, comparative-political-systems-analysis, complexity-bias-resistance, compounding, conjunction-fallacy, consulting-firms-methodology, counterfactual-reasoning, creative-destruction, critical-mass, critical-thinking, cultural-dimensions-theory, cultural-intelligence, curiosity, curse-of-knowledge, cybersecurity-thinking-models, data-science-reasoning-framework, debugging-strategies, deliberate-practice, desirable-difficulties, dialectical-reasoning, divergent-vs-convergent-thinking, dunning-kruger-effect, einstellung-effect, elasticity, endowment-effect, evolutionary-pressure, expertise-reversal-effect, extreme-performance-evaluation, false-precision-avoidance, feedback-loops, feynman-technique, generation-effect, gestalt-principles-of-perception, goal-setting, growth-mindset, habit-formation, hanlons-razor, hindsight-bias, information-theory, internal-locus-of-control, international-negotiation-and-diplomacy-models, iteration, lateral-thinking, latticework-of-mental-models, lean-startup-methodology, learning-curve, liking-principle, logical-fallacies, mental-models-of-reality, mental-simulation, meta-cognitive-reflection, metacognitive-questioning, monte-carlo-methods, multicultural-team-dynamics, narratives, non-linear-dynamics, perceptual-learning, persistence-grit, persuasion-principles, peter-principle, power-laws, pre-suasion, prospect-theory, rationalization, reasoning-mode-router, reciprocity-principle, redundancy, reframing-perspective, regression-to-the-mean, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, risk-vs-uncertainty, scaffolding, scaffolding-educational, scale-economies, schema-acquisition, self-control, self-determination-theory, self-organization-and-emergent-order, signaling, simplification, specialization, statistical-learning-theory, statistics-concepts, storytelling-frameworks, supply-and-demand, switching-costs, synthesis-and-integration, system-1, system-2, theory-induced-blindness, tier-2-high-value, time-tested-validation, tipping-points, tradition-vs-innovation-balance, understanding-motivations, usability-heuristics, user-experience-research-methods, variation-and-selection, varied-practice-interleaving, wysiati, zone-of-development: `{'explicit': 4, 'not_supported_by_source': 2}`
...
Median affordance-level source quote length: `113` characters.
...
- `latticework-of-mental-models.cross-check-causal-layers`: shortest quote `46` chars across `3` quote(s)
...
- `chain-of-thought.audit-stepwise-reasoning`: shortest quote `51` chars across `3` quote(s)
