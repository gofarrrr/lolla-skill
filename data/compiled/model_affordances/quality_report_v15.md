# Model Affordance Quality Report v15
...
- Contributing records: `182`
- Compiled affordances: `218`
- Compiled absence records: `349`
- Affordance count distribution per model:
  - `1` affordance(s): abstraction, active-listening, adaptation, adverse-selection, algorithmic-thinking, analogies-and-metaphors, anchoring, antifragility, association, auditability-traceability, authenticity, authority-bias, base-rates, baseline-establishment, batna, bayesian, bias-blind-spot, blooms-taxonomy, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, calculated-risk-taking, chain-of-verification, chaos-theory, checklists, circle-of-control, cognitive-biases, cognitive-dissonance, cognitive-gaps-assessment, cognitive-load-theory, combinatorial-effects, commitment-bias, comparative-advantage, compounding, confirmation-bias, conjunction-fallacy, constraints, constructive-feedback-models, counterfactual-reasoning, creative-destruction, critical-mass, critical-thinking, cross-cultural-communication-frameworks, curiosity, curse-of-knowledge, cybersecurity-thinking-models, data-science-reasoning-framework, debugging-strategies, delays, deliberate-practice, desirable-difficulties, devops-and-continuous-integration, dialectical-reasoning, divergent-vs-convergent-thinking, dunning-kruger-effect, einstellung-effect, emotional-intelligence, expected-value, expertise-reversal-effect, false-precision-avoidance, falsifiability, feedback-loops, feedback-models-sbi, feynman-technique, first-principles-thinking, five-whys-method, flow, formal-reasoning, game-theory-payoffs, generation-effect, goal-setting, growth-mindset, habit-formation, hanlons-razor, hindsight-bias, information-theory, input-vs-output-goals, intellectual-humility, internal-locus-of-control, international-negotiation-and-diplomacy-models, iteration, jobs-to-be-done, johari-window, lateral-thinking, lean-startup-methodology, learning-curve, lindy-effect, lock-in, margin-of-safety, markov-chains, mental-simulation, metacognitive-questioning, monte-carlo-methods, multi-criteria-decision-analysis, nash-equilibrium, natural-selection-analogy, non-linear-dynamics, non-violent-communication, obligations-controls-mapping, occams-razor, opportunity-cost, optimism-bias-and-planning-fallacy, pareto-principle, path-dependence, peer-review-your-perspectives, persistence-grit, persuasion-principles, power-laws, premortem, principal-agent-problem, prisoners-dilemma, probabilistic-thinking, prospect-theory, rationalization, reasoning-mode-router, reciprocity-principle, red-queen-effect, redundancy, reframing-perspective, regression-to-the-mean, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, resilience, risk-assessment, risk-vs-uncertainty, root-cause-analysis, scaffolding, schema-acquisition, scientific-method-evidence-testing, second-order-thinking, self-control, self-determination-theory, signaling, six-thinking-hats, statistical-learning-theory, statistics-concepts, status-quo-bias, step-back, sunk-cost-fallacy, switching-costs, synthesis-and-integration, theory-induced-blindness, tipping-points, trade-offs, true-uncertainty-navigation, understanding-motivations, user-centered-design, variation-and-selection, varied-practice-interleaving, wysiati, zone-of-development
...
- abstraction, adaptation, algorithmic-thinking, association, auditability-traceability, authenticity, baseline-establishment, bayesian, bias-blind-spot, blooms-taxonomy, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, chaos-theory, cognitive-biases, cognitive-dissonance, cognitive-gaps-assessment, cognitive-load-theory, combinatorial-effects, compounding, conjunction-fallacy, counterfactual-reasoning, creative-destruction, critical-mass, critical-thinking, curiosity, curse-of-knowledge, cybersecurity-thinking-models, data-science-reasoning-framework, debugging-strategies, deliberate-practice, desirable-difficulties, dialectical-reasoning, divergent-vs-convergent-thinking, dunning-kruger-effect, einstellung-effect, expertise-reversal-effect, false-precision-avoidance, feedback-loops, feynman-technique, generation-effect, goal-setting, growth-mindset, habit-formation, hanlons-razor, hindsight-bias, information-theory, internal-locus-of-control, international-negotiation-and-diplomacy-models, iteration, lateral-thinking, lean-startup-methodology, learning-curve, mental-simulation, metacognitive-questioning, monte-carlo-methods, non-linear-dynamics, persistence-grit, persuasion-principles, power-laws, prospect-theory, rationalization, reasoning-mode-router, reciprocity-principle, redundancy, reframing-perspective, regression-to-the-mean, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, risk-vs-uncertainty, scaffolding, schema-acquisition, self-control, self-determination-theory, signaling, statistical-learning-theory, statistics-concepts, switching-costs, synthesis-and-integration, theory-induced-blindness, tipping-points, understanding-motivations, variation-and-selection, varied-practice-interleaving, wysiati, zone-of-development: `{'explicit': 4, 'not_supported_by_source': 2}`
...
Median affordance-level source quote length: `119` characters.
