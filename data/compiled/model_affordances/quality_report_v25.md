# Model Affordance Quality Report v25
...
- Compiled affordances: `268`
- Compiled absence records: `454`
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `37`
  - `not_supported_by_source`: `399`
  - `source_too_thin`: `17`
...
| `active-listening` | 1 | 3 | `high` | none |
...
| `chain-of-thought` | 1 | 3 | `high` | none |
...
| `inversion` | 3 | 1 | `high` | `inversion.obstacle-removal-before-added-force` |
...
| `meta-cognitive-reflection` | 1 | 3 | `high` | none |
...
| `second-order-thinking` | 1 | 1 | `high` | none |
...
| `systems-thinking` | 4 | 1 | `high` | `systems-thinking.structure-over-events` |
...
- emotional-intelligence, feedback-loops, redundancy, switching-costs: `{'explicit': 8, 'not_supported_by_source': 2}`
...
- active-listening, constructive-feedback-models: `{'explicit': 6, 'not_supported_by_source': 3}`
...
Median affordance-level source quote length: `112` characters.
