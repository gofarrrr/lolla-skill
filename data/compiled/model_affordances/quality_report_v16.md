# Model Affordance Quality Report v16
...
- abstraction, adaptation, algorithmic-thinking, association, auditability-traceability, authenticity, baseline-establishment, bayesian, bias-blind-spot, blooms-taxonomy, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, category-decisions, chaos-theory, cognitive-biases, cognitive-dissonance, cognitive-gaps-assessment, cognitive-load-theory, combinatorial-effects, compounding, conjunction-fallacy, counterfactual-reasoning, creative-destruction, critical-mass, critical-thinking, cultural-dimensions-theory, cultural-intelligence, curiosity, curse-of-knowledge, cybersecurity-thinking-models, data-science-reasoning-framework, debugging-strategies, deliberate-practice, desirable-difficulties, dialectical-reasoning, divergent-vs-convergent-thinking, dunning-kruger-effect, einstellung-effect, expertise-reversal-effect, false-precision-avoidance, feedback-loops, feynman-technique, generation-effect, gestalt-principles-of-perception, goal-setting, growth-mindset, habit-formation, hanlons-razor, hindsight-bias, information-theory, internal-locus-of-control, international-negotiation-and-diplomacy-models, iteration, lateral-thinking, lean-startup-methodology, learning-curve, liking-principle, mental-simulation, metacognitive-questioning, monte-carlo-methods, multicultural-team-dynamics, narratives, non-linear-dynamics, persistence-grit, persuasion-principles, power-laws, pre-suasion, prospect-theory, rationalization, reasoning-mode-router, reciprocity-principle, redundancy, reframing-perspective, regression-to-the-mean, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, risk-vs-uncertainty, scaffolding, schema-acquisition, self-control, self-determination-theory, signaling, simplification, statistical-learning-theory, statistics-concepts, storytelling-frameworks, switching-costs, synthesis-and-integration, theory-induced-blindness, tipping-points, understanding-motivations, usability-heuristics, user-experience-research-methods, variation-and-selection, varied-practice-interleaving, wysiati, zone-of-development: `{'explicit': 4, 'not_supported_by_source': 2}`
...
Median affordance-level source quote length: `117` characters.
...
- `einstellung-effect.familiar-solution-lock-in-interrupt`: shortest quote `116` chars across `3` quote(s)
