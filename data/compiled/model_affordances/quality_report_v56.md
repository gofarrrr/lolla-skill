# Model Affordance Quality Report v56
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `70`
  - `not_supported_by_source`: `536`
  - `source_too_thin`: `17`
...
| `false-precision-avoidance` | 1 | 4 | `high` | none |
...
| `representativeness-heuristic` | 1 | 3 | `high` | none |
...
- chain-of-thought, lean-startup-methodology: `{'explicit': 8, 'not_supported_by_source': 8}`
