# Model Affordance Quality Report v7
...
- Contributing records: `88`
- Compiled affordances: `124`
- Compiled absence records: `161`
- Affordance count distribution per model:
  - `1` affordance(s): active-listening, adverse-selection, analogies-and-metaphors, anchoring, antifragility, authority-bias, base-rates, batna, calculated-risk-taking, chain-of-verification, checklists, circle-of-control, commitment-bias, comparative-advantage, confirmation-bias, constraints, constructive-feedback-models, cross-cultural-communication-frameworks, delays, expected-value, falsifiability, feedback-models-sbi, first-principles-thinking, five-whys-method, flow, formal-reasoning, game-theory-payoffs, intellectual-humility, jobs-to-be-done, johari-window, lindy-effect, lock-in, margin-of-safety, multi-criteria-decision-analysis, nash-equilibrium, natural-selection-analogy, obligations-controls-mapping, occams-razor, opportunity-cost, optimism-bias-and-planning-fallacy, pareto-principle, path-dependence, peer-review-your-perspectives, premortem, principal-agent-problem, prisoners-dilemma, probabilistic-thinking, red-queen-effect, resilience, risk-assessment, root-cause-analysis, scientific-method-evidence-testing, second-order-thinking, six-thinking-hats, status-quo-bias, step-back, sunk-cost-fallacy, trade-offs, true-uncertainty-navigation, user-centered-design
...
- batna, cross-cultural-communication-frameworks, game-theory-payoffs, lock-in, nash-equilibrium, red-queen-effect: `{'explicit': 5, 'not_supported_by_source': 2}`
