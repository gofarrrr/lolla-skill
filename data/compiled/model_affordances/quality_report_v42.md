# Model Affordance Quality Report v42
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `63`
  - `not_supported_by_source`: `439`
  - `source_too_thin`: `17`
...
| `false-precision-avoidance` | 1 | 3 | `high` | none |
...
- butterfly-effect, elasticity, input-vs-output-goals, internal-locus-of-control, self-organization-and-emergent-order: `{'explicit': 4, 'not_supported_by_source': 3}`
...
- baseline-establishment, category-decisions, chaos-theory: `{'explicit': 4, 'not_supported_by_source': 4}`
...
- `what would you have to` appears in `7` affordance(s): `anchoring.provisional-anchor-with-correction`, `constraints.constraint-fit-stress-test`, `decomposition.test-cuts-and-assumptions`, `expected-value.probability-weighted-payoff-boundary`, `premortem.simulated-failure-to-plan-change`, `problem-framing-and-reframing.falsify-frame-assumptions`, `trade-offs.allocation-backed-sacrifice`
