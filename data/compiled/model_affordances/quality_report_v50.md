# Model Affordance Quality Report v50
...
- Compiled affordances: `294`
- Compiled absence records: `568`
...
- checklists, delays, formal-reasoning, jobs-to-be-done, natural-selection-analogy, obligations-controls-mapping, optimism-bias-and-planning-fallacy, user-centered-design: `{'explicit': 6, 'not_supported_by_source': 2}`
...
Median affordance-level source quote length: `106` characters.
