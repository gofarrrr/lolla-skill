# Model Affordance Quality Report v43
...
- abstraction, adaptation, agile-methodologies, algorithmic-thinking, association, auditability-traceability, authenticity, bias-blind-spot, blooms-taxonomy, boundaries, brainstorming, branch-solve-merge, causal-attribution-resistance, circle-of-competence, cognitive-biases, cognitive-dissonance, cognitive-gaps-assessment, cognitive-load-theory, combinatorial-effects, comparative-political-systems-analysis, complexity-bias-resistance, compounding, consulting-firms-methodology, counterfactual-reasoning, creative-destruction, critical-mass, curiosity, cybersecurity-thinking-models, debugging-strategies, deliberate-practice, desirable-difficulties, dialectical-reasoning, divergent-vs-convergent-thinking, dunning-kruger-effect, einstellung-effect, endowment-effect, expertise-reversal-effect, extreme-performance-evaluation, feynman-technique, generation-effect, gestalt-principles-of-perception, goal-setting, habit-formation, hanlons-razor, hindsight-bias, iteration, lateral-thinking, lean-startup-methodology, learning-curve, logical-fallacies, multicultural-team-dynamics, non-linear-dynamics, persistence-grit, peter-principle, power-laws, prospect-theory, rationalization, reframing-perspective, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, scale-economies, schema-acquisition, self-control, self-determination-theory, simplification, specialization, supply-and-demand, synthesis-and-integration, system-1, system-2, theory-induced-blindness, tier-2-high-value, time-tested-validation, tipping-points, tradition-vs-innovation-balance, usability-heuristics, user-experience-research-methods, variation-and-selection, varied-practice-interleaving, wysiati, zone-of-development: `{'explicit': 4, 'not_supported_by_source': 2}`
...
- cross-cultural-communication-frameworks, curse-of-knowledge, emotional-intelligence, feedback-loops, redundancy, storytelling-frameworks, switching-costs: `{'explicit': 8, 'not_supported_by_source': 2}`
- butterfly-effect, elasticity, input-vs-output-goals, internal-locus-of-control, regression-to-the-mean, self-organization-and-emergent-order: `{'explicit': 4, 'not_supported_by_source': 3}`
...
- cultural-intelligence, latticework-of-mental-models, perceptual-learning, pre-suasion, reciprocity-principle: `{'explicit': 7, 'not_supported_by_source': 2}`
...
- growth-mindset, scaffolding, scaffolding-educational: `{'explicit': 4, 'not_supported_by_source': 2, 'review_note': 3}`
...
- first-principles-thinking, liking-principle: `{'explicit': 7, 'not_supported_by_source': 3}`
...
Median affordance-level source quote length: `107` characters.
