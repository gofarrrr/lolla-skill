# Model Affordance Quality Report v27
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `44`
  - `not_supported_by_source`: `403`
  - `source_too_thin`: `17`
...
| `mental-models-of-reality` | 1 | 3 | `high` | none |
...
- baseline-establishment, category-decisions, mental-models-of-reality: `{'explicit': 4, 'not_supported_by_source': 4}`
