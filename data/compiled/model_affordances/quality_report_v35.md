# Model Affordance Quality Report v35
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `54`
  - `not_supported_by_source`: `429`
  - `source_too_thin`: `17`
...
Median affordance-level source quote length: `109` characters.
