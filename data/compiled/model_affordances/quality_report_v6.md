# Model Affordance Quality Report v6
...
- Contributing records: `81`
- Compiled affordances: `117`
- Compiled absence records: `147`
- Affordance count distribution per model:
  - `1` affordance(s): adverse-selection, anchoring, antifragility, authority-bias, base-rates, batna, calculated-risk-taking, chain-of-verification, checklists, circle-of-control, commitment-bias, comparative-advantage, confirmation-bias, constraints, cross-cultural-communication-frameworks, delays, expected-value, falsifiability, first-principles-thinking, five-whys-method, flow, formal-reasoning, game-theory-payoffs, intellectual-humility, jobs-to-be-done, johari-window, lindy-effect, lock-in, margin-of-safety, multi-criteria-decision-analysis, obligations-controls-mapping, occams-razor, opportunity-cost, optimism-bias-and-planning-fallacy, pareto-principle, path-dependence, peer-review-your-perspectives, premortem, principal-agent-problem, probabilistic-thinking, red-queen-effect, resilience, risk-assessment, root-cause-analysis, scientific-method-evidence-testing, second-order-thinking, six-thinking-hats, status-quo-bias, step-back, sunk-cost-fallacy, trade-offs, true-uncertainty-navigation, user-centered-design
...
- checklists, commitment-bias, delays, formal-reasoning, jobs-to-be-done, obligations-controls-mapping, optimism-bias-and-planning-fallacy, path-dependence, peer-review-your-perspectives, status-quo-bias, user-centered-design: `{'explicit': 6, 'not_supported_by_source': 2}`
- batna, cross-cultural-communication-frameworks, game-theory-payoffs, lock-in, red-queen-effect: `{'explicit': 5, 'not_supported_by_source': 2}`
