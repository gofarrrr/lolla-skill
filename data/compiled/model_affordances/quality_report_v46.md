# Model Affordance Quality Report v46
...
- Compiled affordances: `287`
- Compiled absence records: `555`
- Affordance count distribution per model:
  ...
  - `2` affordance(s): aleatory-epistemic-uncertainty-recognition, black-swan-events, commitment-bias, constraints, correlation-vs-causation, cross-cultural-communication-frameworks, curse-of-knowledge, data-science-reasoning-framework, decision-trees, decomposition, emergence, emotional-intelligence, experimentation, expertise-reversal-effect, feedback-loops, incentives, law-of-large-numbers, learning-curve, lock-in, mental-simulation, metacognitive-questioning, moral-hazard, nash-equilibrium, network-effects, optimization-theory, optionality, path-dependence, perceptual-learning, prioritization, psychological-safety, redundancy, signaling, social-proof, statistical-discipline, status-quo-bias, sunk-cost-fallacy, survivorship-bias, switching-costs, theory-of-constraints
  - `3` affordance(s): complex-adaptive-systems, confidence-calibration, empathy, game-theory-payoffs, information-asymmetry, power-dynamics, problem-framing-and-reframing
...
- analogies-and-metaphors, checklists, delays, formal-reasoning, jobs-to-be-done, natural-selection-analogy, obligations-controls-mapping, optimism-bias-and-planning-fallacy, peer-review-your-perspectives, user-centered-design: `{'explicit': 6, 'not_supported_by_source': 2}`
- baseline-establishment, category-decisions, chaos-theory, monte-carlo-methods, risk-vs-uncertainty, statistics-concepts: `{'explicit': 4, 'not_supported_by_source': 4}`
...
- confirmation-bias, intellectual-humility, scientific-method-evidence-testing, step-back: `{'explicit': 8, 'not_supported_by_source': 3}`
- curse-of-knowledge, lock-in, mental-simulation, perceptual-learning: `{'explicit': 9, 'not_supported_by_source': 2}`
...
- prisoners-dilemma, status-quo-bias: `{'explicit': 11, 'not_supported_by_source': 2}`
...
- `what would have to be` appears in `3` affordance(s): `complex-adaptive-systems.assumption-and-bias-exposure`, `leverage-points.assumption-antithesis-test`, `true-uncertainty-navigation.scenario-bound-robust-action`
