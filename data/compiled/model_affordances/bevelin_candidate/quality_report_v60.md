# Model Affordance Quality Report v60 Bevelin Candidate
...
- Compiled affordances: `308`
- Compiled absence records: `697`
- Affordance count distribution per model:
  - `1` affordance(s): adaptation, adverse-selection, agile-methodologies, algorithmic-thinking, anchoring, antifragility, auditability-traceability, authenticity, authority-bias, base-rates, batna, bayesian, bias-blind-spot, blooms-taxonomy, bottlenecks, boundaries, brainstorming, branch-solve-merge, butterfly-effect, calculated-risk-taking, causal-attribution-resistance, chain-of-thought, chain-of-verification, chaos-theory, checklists, circle-of-competence, circle-of-control, cognitive-biases, cognitive-gaps-assessment, cognitive-load-theory, combinatorial-effects, comparative-advantage, comparative-political-systems-analysis, complexity-bias-resistance, compounding, conjunction-fallacy, constructive-feedback-models, consulting-firms-methodology, creative-destruction, critical-mass, cultural-dimensions-theory, cultural-intelligence, curiosity, cybersecurity-thinking-models, debugging-strategies, delays, deliberate-practice, desirable-difficulties, devops-and-continuous-integration, dialectical-reasoning, divergent-vs-convergent-thinking, dunning-kruger-effect, einstellung-effect, elasticity, endowment-effect, evolutionary-pressure, expected-value, extreme-performance-evaluation, false-precision-avoidance, falsifiability, feedback-models-sbi, feynman-technique, first-principles-thinking, five-whys-method, flow, formal-reasoning, generation-effect, gestalt-principles-of-perception, goal-setting, growth-mindset, habit-formation, hanlons-razor, hindsight-bias, information-theory, input-vs-output-goals, intellectual-humility, internal-locus-of-control, international-negotiation-and-diplomacy-models, iteration, jobs-to-be-done, johari-window, lateral-thinking, latticework-of-mental-models, liking-principle, lindy-effect, logical-fallacies, margin-of-safety, markov-chains, mental-models-of-reality, meta-cognitive-reflection, monte-carlo-methods, multi-criteria-decision-analysis, multicultural-team-dynamics, narratives, natural-selection-analogy, non-linear-dynamics, non-violent-communication, occams-razor, opportunity-cost, optimism-bias-and-planning-fallacy, pareto-principle, peer-review-your-perspectives, persistence-grit, persuasion-principles, peter-principle, power-laws, pre-suasion, premortem, principal-agent-problem, prisoners-dilemma, probabilistic-thinking, prospect-theory, rationalization, reasoning-mode-router, reciprocity-principle, red-queen-effect, reframing-perspective, regression-to-the-mean, regret-theory, regulatory-horizon-scanning, representativeness-heuristic, resilience, risk-assessment, risk-vs-uncertainty, root-cause-analysis, scaffolding, scaffolding-educational, scale-economies, schema-acquisition, scientific-method-evidence-testing, second-order-thinking, self-determination-theory, self-organization-and-emergent-order, simplification, six-thinking-hats, specialization, statistical-learning-theory, statistics-concepts, step-back, storytelling-frameworks, supply-and-demand, synthesis-and-integration, system-1, system-2, theory-induced-blindness, tier-2-high-value, time-tested-validation, tipping-points, trade-offs, tradition-vs-innovation-balance, usability-heuristics, variation-and-selection, varied-practice-interleaving, wysiati, zone-of-development
  - `2` affordance(s): abstraction, active-listening, aleatory-epistemic-uncertainty-recognition, analogies-and-metaphors, association, baseline-establishment, black-swan-events, category-decisions, cognitive-dissonance, commitment-bias, confirmation-bias, constraints, correlation-vs-causation, counterfactual-reasoning, cross-cultural-communication-frameworks, curse-of-knowledge, data-science-reasoning-framework, decision-trees, decomposition, emergence, emotional-intelligence, experimentation, expertise-reversal-effect, incentives, law-of-large-numbers, lean-startup-methodology, learning-curve, lock-in, metacognitive-questioning, moral-hazard, nash-equilibrium, network-effects, obligations-controls-mapping, optimization-theory, optionality, path-dependence, perceptual-learning, price-discrimination, prioritization, psychological-safety, redundancy, self-control, signaling, social-proof, statistical-discipline, status-quo-bias, sunk-cost-fallacy, survivorship-bias, switching-costs, theory-of-constraints, true-uncertainty-navigation, understanding-motivations, user-centered-design, user-experience-research-methods
  - `3` affordance(s): complex-adaptive-systems, confidence-calibration, critical-thinking, empathy, feedback-loops, game-theory-payoffs, information-asymmetry, mental-simulation, power-dynamics, problem-framing-and-reframing
  - `4` affordance(s): systems-thinking
  - `5` affordance(s): inversion
  - `6` affordance(s): leverage-points
- Absence record status counts:
  - `deferred_for_review`: `1`
  - `duplicate_of_existing_field`: `99`
  - `not_supported_by_source`: `571`
  - `source_too_thin`: `26`
...
| --- | ---: | ---: | --- | --- |
| `abstraction` | 2 | 2 | `high` | none |
| `active-listening` | 2 | 7 | `high` | none |
| `adaptation` | 1 | 2 | `high` | none |
| `adverse-selection` | 1 | 4 | `medium` | none |
| `agile-methodologies` | 1 | 5 | `high` | none |
| `aleatory-epistemic-uncertainty-recognition` | 2 | 2 | `high` | none |
| `algorithmic-thinking` | 1 | 2 | `high` | none |
| `analogies-and-metaphors` | 2 | 2 | `high` | none |
| `anchoring` | 1 | 3 | `high` | none |
| `antifragility` | 1 | 4 | `high` | none |
| `association` | 2 | 3 | `high` | none |
| `auditability-traceability` | 1 | 2 | `high` | none |
| `authenticity` | 1 | 5 | `high` | none |
| `authority-bias` | 1 | 2 | `high` | none |
| `base-rates` | 1 | 4 | `high` | none |
| `baseline-establishment` | 2 | 3 | `high` | none |
| `batna` | 1 | 4 | `medium` | none |
| `bayesian` | 1 | 4 | `high` | none |
| `bias-blind-spot` | 1 | 2 | `high` | none |
| `black-swan-events` | 2 | 3 | `high` | none |
| `blooms-taxonomy` | 1 | 3 | `high` | none |
| `bottlenecks` | 1 | 2 | `high` | none |
| `boundaries` | 1 | 5 | `high` | none |
| `brainstorming` | 1 | 2 | `high` | none |
| `branch-solve-merge` | 1 | 2 | `high` | none |
| `butterfly-effect` | 1 | 2 | `high` | none |
| `calculated-risk-taking` | 1 | 6 | `high` | none |
| `category-decisions` | 2 | 5 | `high` | none |
| `causal-attribution-resistance` | 1 | 2 | `high` | none |
| `chain-of-thought` | 1 | 6 | `high` | none |
| `chain-of-verification` | 1 | 4 | `high` | none |
| `chaos-theory` | 1 | 3 | `high` | none |
| `checklists` | 1 | 2 | `high` | none |
| `circle-of-competence` | 1 | 4 | `high` | none |
| `circle-of-control` | 1 | 5 | `high` | none |
| `cognitive-biases` | 1 | 5 | `high` | none |
| `cognitive-dissonance` | 2 | 2 | `high` | none |
| `cognitive-gaps-assessment` | 1 | 5 | `high` | none |
| `cognitive-load-theory` | 1 | 3 | `high` | none |
...
| `confirmation-bias` | 2 | 2 | `high` | none |
| `conjunction-fallacy` | 1 | 6 | `high` | none |
| `constraints` | 2 | 2 | `high` | none |
...
| `counterfactual-reasoning` | 2 | 3 | `high` | none |
| `creative-destruction` | 1 | 2 | `high` | none |
| `critical-mass` | 1 | 2 | `high` | none |
| `critical-thinking` | 3 | 5 | `high` | none |
| `cross-cultural-communication-frameworks` | 2 | 2 | `high` | none |
| `cultural-dimensions-theory` | 1 | 3 | `high` | none |
| `cultural-intelligence` | 1 | 2 | `high` | none |
| `curiosity` | 1 | 2 | `high` | none |
| `curse-of-knowledge` | 2 | 2 | `high` | none |
| `cybersecurity-thinking-models` | 1 | 2 | `high` | none |
| `data-science-reasoning-framework` | 2 | 3 | `high` | none |
| `debugging-strategies` | 1 | 6 | `high` | none |
| `decision-trees` | 2 | 3 | `high` | none |
| `decomposition` | 2 | 2 | `high` | none |
| `delays` | 1 | 2 | `high` | none |
| `deliberate-practice` | 1 | 3 | `high` | none |
| `desirable-difficulties` | 1 | 3 | `high` | none |
| `devops-and-continuous-integration` | 1 | 4 | `medium` | none |
| `dialectical-reasoning` | 1 | 2 | `high` | none |
| `divergent-vs-convergent-thinking` | 1 | 3 | `high` | none |
| `dunning-kruger-effect` | 1 | 4 | `high` | none |
| `einstellung-effect` | 1 | 2 | `high` | none |
| `elasticity` | 1 | 3 | `high` | none |
| `emergence` | 2 | 3 | `high` | none |
| `emotional-intelligence` | 2 | 2 | `high` | none |
| `empathy` | 3 | 2 | `high` | none |
| `endowment-effect` | 1 | 2 | `high` | none |
| `evolutionary-pressure` | 1 | 6 | `high` | none |
| `expected-value` | 1 | 4 | `high` | none |
| `experimentation` | 2 | 3 | `high` | none |
| `expertise-reversal-effect` | 2 | 3 | `high` | none |
| `extreme-performance-evaluation` | 1 | 2 | `high` | none |
| `false-precision-avoidance` | 1 | 7 | `high` | none |
| `falsifiability` | 1 | 2 | `high` | none |
| `feedback-loops` | 3 | 5 | `high` | none |
| `feedback-models-sbi` | 1 | 4 | `high` | none |
| `feynman-technique` | 1 | 3 | `high` | none |
| `first-principles-thinking` | 1 | 2 | `high` | none |
| `five-whys-method` | 1 | 2 | `high` | none |
| `flow` | 1 | 5 | `high` | none |
| `formal-reasoning` | 1 | 2 | `high` | none |
| `game-theory-payoffs` | 3 | 3 | `high` | none |
| `generation-effect` | 1 | 3 | `high` | none |
| `gestalt-principles-of-perception` | 1 | 2 | `high` | none |
| `goal-setting` | 1 | 4 | `high` | none |
| `growth-mindset` | 1 | 3 | `high` | none |
| `habit-formation` | 1 | 5 | `high` | none |
| `hanlons-razor` | 1 | 2 | `high` | none |
| `hindsight-bias` | 1 | 2 | `high` | none |
| `incentives` | 2 | 2 | `high` | none |
| `information-asymmetry` | 3 | 3 | `high` | none |
| `information-theory` | 1 | 3 | `high` | none |
| `input-vs-output-goals` | 1 | 3 | `high` | none |
| `intellectual-humility` | 1 | 3 | `high` | none |
| `internal-locus-of-control` | 1 | 7 | `high` | none |
| `international-negotiation-and-diplomacy-models` | 1 | 5 | `high` | none |
| `inversion` | 5 | 3 | `high` | `inversion.obstacle-removal-before-added-force` |
| `iteration` | 1 | 7 | `high` | none |
| `jobs-to-be-done` | 1 | 2 | `high` | none |
| `johari-window` | 1 | 5 | `high` | none |
| `lateral-thinking` | 1 | 2 | `high` | none |
| `latticework-of-mental-models` | 1 | 3 | `high` | none |
| `law-of-large-numbers` | 2 | 3 | `high` | none |
| `lean-startup-methodology` | 2 | 6 | `high` | none |
| `learning-curve` | 2 | 3 | `high` | none |
| `leverage-points` | 6 | 2 | `high` | none |
| `liking-principle` | 1 | 3 | `high` | none |
| `lindy-effect` | 1 | 2 | `high` | none |
| `lock-in` | 2 | 2 | `high` | none |
| `logical-fallacies` | 1 | 3 | `high` | none |
| `margin-of-safety` | 1 | 4 | `high` | none |
| `markov-chains` | 1 | 6 | `medium` | none |
| `mental-models-of-reality` | 1 | 6 | `high` | none |
| `mental-simulation` | 3 | 3 | `high` | none |
| `meta-cognitive-reflection` | 1 | 4 | `high` | none |
| `metacognitive-questioning` | 2 | 2 | `high` | none |
| `monte-carlo-methods` | 1 | 4 | `high` | none |
| `moral-hazard` | 2 | 3 | `high` | none |
| `multi-criteria-decision-analysis` | 1 | 4 | `high` | none |
| `multicultural-team-dynamics` | 1 | 2 | `high` | none |
| `narratives` | 1 | 3 | `high` | none |
| `nash-equilibrium` | 2 | 2 | `high` | none |
| `natural-selection-analogy` | 1 | 2 | `high` | none |
| `network-effects` | 2 | 2 | `high` | none |
| `non-linear-dynamics` | 1 | 2 | `high` | none |
| `non-violent-communication` | 1 | 6 | `high` | none |
| `obligations-controls-mapping` | 2 | 2 | `high` | none |
| `occams-razor` | 1 | 2 | `high` | none |
| `opportunity-cost` | 1 | 3 | `high` | none |
...
| `peer-review-your-perspectives` | 1 | 3 | `high` | none |
| `perceptual-learning` | 2 | 2 | `high` | none |
| `persistence-grit` | 1 | 4 | `high` | none |
| `persuasion-principles` | 1 | 7 | `high` | none |
| `peter-principle` | 1 | 2 | `high` | none |
| `power-dynamics` | 3 | 2 | `high` | none |
| `power-laws` | 1 | 2 | `high` | none |
| `pre-suasion` | 1 | 6 | `high` | none |
| `premortem` | 1 | 4 | `high` | none |
| `price-discrimination` | 2 | 5 | `medium` | none |
| `principal-agent-problem` | 1 | 4 | `medium` | none |
| `prioritization` | 2 | 4 | `high` | none |
| `prisoners-dilemma` | 1 | 2 | `high` | none |
| `probabilistic-thinking` | 1 | 4 | `high` | none |
...
| `reasoning-mode-router` | 1 | 5 | `high` | none |
...
| `regression-to-the-mean` | 1 | 4 | `high` | none |
| `regret-theory` | 1 | 2 | `high` | none |
| `regulatory-horizon-scanning` | 1 | 2 | `high` | none |
| `representativeness-heuristic` | 1 | 6 | `high` | none |
| `resilience` | 1 | 5 | `high` | none |
| `risk-assessment` | 1 | 5 | `high` | none |
| `risk-vs-uncertainty` | 1 | 5 | `high` | none |
| `root-cause-analysis` | 1 | 2 | `high` | none |
| `scaffolding` | 1 | 3 | `high` | none |
| `scaffolding-educational` | 1 | 4 | `high` | none |
| `scale-economies` | 1 | 2 | `high` | none |
| `schema-acquisition` | 1 | 3 | `high` | none |
| `scientific-method-evidence-testing` | 1 | 3 | `high` | none |
| `second-order-thinking` | 1 | 4 | `high` | none |
| `self-control` | 2 | 6 | `high` | none |
| `self-determination-theory` | 1 | 2 | `high` | none |
| `self-organization-and-emergent-order` | 1 | 2 | `high` | none |
| `signaling` | 2 | 3 | `high` | none |
| `simplification` | 1 | 2 | `high` | none |
| `six-thinking-hats` | 1 | 5 | `medium` | none |
| `social-proof` | 2 | 4 | `high` | none |
| `specialization` | 1 | 2 | `high` | none |
| `statistical-discipline` | 2 | 2 | `high` | none |
| `statistical-learning-theory` | 1 | 5 | `high` | none |
| `statistics-concepts` | 1 | 3 | `high` | none |
| `status-quo-bias` | 2 | 2 | `high` | none |
| `step-back` | 1 | 2 | `high` | none |
| `storytelling-frameworks` | 1 | 7 | `high` | none |
| `sunk-cost-fallacy` | 2 | 2 | `high` | none |
...
| `trade-offs` | 1 | 4 | `high` | none |
| `tradition-vs-innovation-balance` | 1 | 2 | `high` | none |
| `true-uncertainty-navigation` | 2 | 3 | `high` | none |
| `understanding-motivations` | 2 | 7 | `high` | none |
| `usability-heuristics` | 1 | 3 | `high` | none |
| `user-centered-design` | 2 | 4 | `high` | none |
| `user-experience-research-methods` | 2 | 3 | `high` | none |
| `variation-and-selection` | 1 | 2 | `high` | none |
| `varied-practice-interleaving` | 1 | 2 | `high` | none |
| `wysiati` | 1 | 3 | `high` | none |
| `zone-of-development` | 1 | 3 | `high` | none |

## Cross-Model Deterministic Observations

### Identical Extraction-Type Distributions

- adaptation, algorithmic-thinking, auditability-traceability, bias-blind-spot, brainstorming, branch-solve-merge, causal-attribution-resistance, combinatorial-effects, comparative-political-systems-analysis, complexity-bias-resistance, compounding, consulting-firms-methodology, creative-destruction, critical-mass, curiosity, cybersecurity-thinking-models, dialectical-reasoning, einstellung-effect, endowment-effect, extreme-performance-evaluation, gestalt-principles-of-perception, hanlons-razor, hindsight-bias, lateral-thinking, multicultural-team-dynamics, non-linear-dynamics, peter-principle, power-laws, prospect-theory, rationalization, reframing-perspective, regret-theory, regulatory-horizon-scanning, scale-economies, self-determination-theory, simplification, specialization, supply-and-demand, synthesis-and-integration, system-1, tier-2-high-value, time-tested-validation, tipping-points, tradition-vs-innovation-balance, variation-and-selection, varied-practice-interleaving: `{'explicit': 4, 'not_supported_by_source': 2}`
- blooms-taxonomy, butterfly-effect, cognitive-load-theory, deliberate-practice, desirable-difficulties, elasticity, feynman-technique, generation-effect, schema-acquisition, self-organization-and-emergent-order, wysiati, zone-of-development: `{'explicit': 4, 'not_supported_by_source': 3}`
- chaos-theory, divergent-vs-convergent-thinking, logical-fallacies, monte-carlo-methods, statistics-concepts, theory-induced-blindness: `{'explicit': 4, 'not_supported_by_source': 4}`
- checklists, delays, formal-reasoning, jobs-to-be-done, natural-selection-analogy, optimism-bias-and-planning-fallacy: `{'explicit': 6, 'not_supported_by_source': 2}`
- cognitive-dissonance, cross-cultural-communication-frameworks, emotional-intelligence, redundancy, switching-costs: `{'explicit': 8, 'not_supported_by_source': 2}`
- abstraction, curse-of-knowledge, lock-in, obligations-controls-mapping, perceptual-learning: `{'explicit': 9, 'not_supported_by_source': 2}`
- agile-methodologies, cultural-dimensions-theory, dunning-kruger-effect, regression-to-the-mean: `{'explicit': 4, 'not_supported_by_source': 5}`
- goal-setting, information-theory, input-vs-output-goals, usability-heuristics: `{'explicit': 4, 'not_supported_by_source': 6}`
- conjunction-fallacy, meta-cognitive-reflection, persistence-grit, risk-vs-uncertainty: `{'explicit': 4, 'not_supported_by_source': 8}`
- expertise-reversal-effect, first-principles-thinking, learning-curve, liking-principle: `{'explicit': 7, 'not_supported_by_source': 3}`
- commitment-bias, metacognitive-questioning, path-dependence: `{'explicit': 10, 'not_supported_by_source': 2}`
- analogies-and-metaphors, prisoners-dilemma, status-quo-bias: `{'explicit': 11, 'not_supported_by_source': 2}`
- bayesian, cognitive-biases, cognitive-gaps-assessment: `{'explicit': 4, 'not_supported_by_source': 3, 'review_note': 5}`
- resilience, social-proof: `{'explicit': 19, 'not_supported_by_source': 6, 'review_note': 2}`
...
- growth-mindset, scaffolding: `{'explicit': 4, 'not_supported_by_source': 2, 'review_note': 3}`
- habit-formation, international-negotiation-and-diplomacy-models: `{'explicit': 4, 'not_supported_by_source': 2, 'review_note': 6}`
- debugging-strategies, iteration: `{'explicit': 4, 'not_supported_by_source': 7}`
- bottlenecks, red-queen-effect: `{'explicit': 5, 'not_supported_by_source': 2}`
- cultural-intelligence, reciprocity-principle: `{'explicit': 7, 'not_supported_by_source': 2}`
- falsifiability, five-whys-method: `{'explicit': 7, 'not_supported_by_source': 3, 'review_note': 1}`
- category-decisions, feedback-models-sbi: `{'explicit': 7, 'not_supported_by_source': 8}`
- association, step-back: `{'explicit': 8, 'not_supported_by_source': 3}`

### Repeated Diagnostic Question Openings

- `is the worst case bad` appears in `13` affordance(s): `aleatory-epistemic-uncertainty-recognition.commitment-gating-by-reducibility`, `anchoring.provisional-anchor-with-correction`, `calculated-risk-taking.pressure-tested-bounded-wager`, `expected-value.probability-weighted-payoff-boundary`, `leverage-points.execution-resistance-plan`, `monte-carlo-methods.distributional-range-stress-test`, `multi-criteria-decision-analysis.auditable-weighted-tradeoff-matrix`, `optionality.preserve-reversible-learning`, `premortem.simulated-failure-to-plan-change`, `probabilistic-thinking.range-and-sensitivity-decision-gate`, `risk-assessment.thresholded-downside-governance`, `statistical-discipline.distributional-inference-stress-test`, `survivorship-bias.restore-failure-tail-outcomes`
- `what would you have to` appears in `8` affordance(s): `anchoring.provisional-anchor-with-correction`, `constraints.constraint-fit-stress-test`, `data-science-reasoning-framework.assumption-pressure-before-analytic-output`, `decomposition.test-cuts-and-assumptions`, `expected-value.probability-weighted-payoff-boundary`, `premortem.simulated-failure-to-plan-change`, `problem-framing-and-reframing.falsify-frame-assumptions`, `trade-offs.allocation-backed-sacrifice`
...
- `what would have to be` appears in `4` affordance(s): `abstraction.abductive-hypothesis-framing-check`, `complex-adaptive-systems.assumption-and-bias-exposure`, `leverage-points.assumption-antithesis-test`, `true-uncertainty-navigation.scenario-bound-robust-action`
...
- `what oneday answer or action` appears in `2` affordance(s): `critical-thinking.claim-evidence-assumption-check`, `critical-thinking.personal-data-action-threshold-check`
...
- `what precursor action result and` appears in `2` affordance(s): `expertise-reversal-effect.extract-tacit-expert-cognition-with-stories`, `perceptual-learning.tacit-cue-extraction-before-training`
- `what specific performance criteria must` appears in `2` affordance(s): `sunk-cost-fallacy.future-value-recommitment`, `sunk-cost-fallacy.precommitment-exit-criteria`
...
- `which facts are enough to` appears in `2` affordance(s): `leverage-points.minimal-fact-threshold`, `network-effects.pre-threshold-adoption-path`

### Affordances With Short Source Quotes

Median affordance-level source quote length: `104` characters.
...
- `price-discrimination.justify-offer-differences-against-alternatives`: shortest quote `17` chars across `5` quote(s)
...
- `self-control.deliberate-pause-before-impulse-action`: shortest quote `19` chars across `5` quote(s)
- `switching-costs.reversibility-decay-exit-plan`: shortest quote `19` chars across `3` quote(s)
- `user-centered-design.reframe-flawed-brief-from-user-observation`: shortest quote `19` chars across `4` quote(s)
...
- `liking-principle.build-receptivity-with-substance-check`: shortest quote `21` chars across `6` quote(s)
...
- `pre-suasion.set-context-with-merit-and-consent-check`: shortest quote `22` chars across `6` quote(s)
- `active-listening.hidden-disagreement-diagnostic-loop`: shortest quote `23` chars across `5` quote(s)
- `feedback-models-sbi.situation-impact-invitation-structure`: shortest quote `23` chars across `5` quote(s)
- `information-theory.signal-preserving-compression`: shortest quote `23` chars across `3` quote(s)
- `reciprocity-principle.costly-value-trust-test`: shortest quote `24` chars across `6` quote(s)
- `critical-thinking.claim-evidence-assumption-check`: shortest quote `25` chars across `10` quote(s)
- `critical-thinking.personal-data-action-threshold-check`: shortest quote `25` chars across `3` quote(s)
...
- `user-experience-research-methods.digital-twin-screening-before-live-commitment`: shortest quote `26` chars across `6` quote(s)
- `analogies-and-metaphors.generative-analogy-search`: shortest quote `27` chars across `5` quote(s)
- `checklists.omission-risk-execution-gate`: shortest quote `27` chars across `4` quote(s)
- `constructive-feedback-models.specific-standard-correction`: shortest quote `27` chars across `10` quote(s)
...
- `counterfactual-reasoning.plausible-alternative-branch-test`: shortest quote `30` chars across `4` quote(s)
...
- `user-centered-design.prototype-user-evidence-loop`: shortest quote `32` chars across `4` quote(s)
- `constraints.scope-boundary-exclusion-filter`: shortest quote `33` chars across `5` quote(s)
...
- `curse-of-knowledge.audience-starting-state-reconstruction`: shortest quote `36` chars across `3` quote(s)
...
- `signaling.create-actionable-coordination-signal`: shortest quote `38` chars across `8` quote(s)
...
- `cultural-intelligence.translate-human-worlds-before-adoption`: shortest quote `39` chars across `6` quote(s)
- `flow.calibrated-immersion-channel`: shortest quote `39` chars across `15` quote(s)
- `leverage-points.focus-check-stop-continue`: shortest quote `39` chars across `4` quote(s)
...
- `narratives.make-causal-meaning-actionable`: shortest quote `40` chars across `6` quote(s)
...
- `confirmation-bias.first-falsifier-before-approval`: shortest quote `41` chars across `4` quote(s)
...
- `signaling.costly-proof-of-intent-test`: shortest quote `42` chars across `6` quote(s)
...
- `sunk-cost-fallacy.precommitment-exit-criteria`: shortest quote `45` chars across `5` quote(s)
...
- `understanding-motivations.motive-to-implementation-path-check`: shortest quote `47` chars across `5` quote(s)
- `abstraction.abductive-hypothesis-framing-check`: shortest quote `48` chars across `5` quote(s)
- `critical-thinking.framework-fit-stress-fracture-check`: shortest quote `48` chars across `3` quote(s)
...
- `data-science-reasoning-framework.assumption-pressure-before-analytic-output`: shortest quote `49` chars across `5` quote(s)
...
- `learning-curve.progressive-scaffold-and-handoff`: shortest quote `50` chars across `3` quote(s)
- `perceptual-learning.train-cue-discrimination`: shortest quote `50` chars across `3` quote(s)
...
- `cognitive-dissonance.private-doubt-before-group-consensus`: shortest quote `51` chars across `4` quote(s)
...
- `counterfactual-reasoning.outcome-quality-retrospective`: shortest quote `52` chars across `5` quote(s)
...
- `category-decisions.category-of-one-positioning-frame`: shortest quote `53` chars across `3` quote(s)
...
- `confirmation-bias.disconfirming-evidence-equality-check`: shortest quote `54` chars across `5` quote(s)
...
- `sunk-cost-fallacy.future-value-recommitment`: shortest quote `54` chars across `17` quote(s)
...
- `bottlenecks.binding-constraint-throughput-check`: shortest quote `55` chars across `4` quote(s)
...
- `perceptual-learning.tacit-cue-extraction-before-training`: shortest quote `59` chars across `5` quote(s)
- `brainstorming.bounded-divergence-before-selection`: shortest quote `60` chars across `3` quote(s)
- `obligations-controls-mapping.role-reversal-system-rule`: shortest quote `60` chars across `3` quote(s)
...
- `curse-of-knowledge.observed-novice-validation-before-clarity-trust`: shortest quote `61` chars across `5` quote(s)
...
- `leverage-points.minimal-fact-threshold`: shortest quote `61` chars across `3` quote(s)
...
- `price-discrimination.segment-offer-by-value-evidence`: shortest quote `63` chars across `3` quote(s)
...
- `prisoners-dilemma.defection-incentive-reframe-test`: shortest quote `64` chars across `9` quote(s)
- `resilience.disciplined-recovery-with-continued-function`: shortest quote `64` chars across `15` quote(s)
- `active-listening.tacit-process-capture-before-abstraction`: shortest quote `65` chars across `5` quote(s)
- `generation-effect.active-articulation-before-belief`: shortest quote `65` chars across `3` quote(s)
- `lean-startup-methodology.subhypothesis-experiment-coverage-map`: shortest quote `65` chars across `4` quote(s)
- `nash-equilibrium.dominant-strategy-mechanism-design`: shortest quote `65` chars across `7` quote(s)
...
- `true-uncertainty-navigation.outcome-decoupled-decision-quality`: shortest quote `67` chars across `4` quote(s)
...
- `mental-simulation.persona-fidelity-role-play`: shortest quote `68` chars across `6` quote(s)
- `association.schema-bridge-for-usable-context`: shortest quote `70` chars across `4` quote(s)
...
- `feedback-loops.absolute-standard-drift-guard`: shortest quote `78` chars across `3` quote(s)
...
- `baseline-establishment.absolute-yardstick-before-contrast`: shortest quote `80` chars across `2` quote(s)
...
- `constraints.constraint-fit-stress-test`: shortest quote `81` chars across `6` quote(s)
...
- `game-theory-payoffs.adverse-response-floor-test`: shortest quote `85` chars across `6` quote(s)
- `information-asymmetry.knowledge-authority-risk-map`: shortest quote `85` chars across `5` quote(s)
- `game-theory-payoffs.credible-sequencing-commitment-device`: shortest quote `86` chars across `5` quote(s)
...
- `cross-cultural-communication-frameworks.align-conversation-layer-before-message`: shortest quote `94` chars across `3` quote(s)
...
- `moral-hazard.proxy-hidden-effort-with-noisy-outcomes`: shortest quote `99` chars across `7` quote(s)
- `learning-curve.measure-capability-compounding-over-time`: shortest quote `100` chars across `3` quote(s)
- `status-quo-bias.default-choice-architecture`: shortest quote `101` chars across `5` quote(s)
