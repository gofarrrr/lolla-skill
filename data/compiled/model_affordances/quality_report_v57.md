# Model Affordance Quality Report v57
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `79`
  - `not_supported_by_source`: `540`
  - `source_too_thin`: `20`
...
| `understanding-motivations` | 1 | 3 | `high` | none |
...
- cognitive-dissonance, cross-cultural-communication-frameworks, emotional-intelligence, redundancy, storytelling-frameworks, switching-costs: `{'explicit': 8, 'not_supported_by_source': 2}`
...
- bottlenecks, non-violent-communication, red-queen-effect: `{'explicit': 5, 'not_supported_by_source': 2}`
- cultural-intelligence, pre-suasion, reciprocity-principle: `{'explicit': 7, 'not_supported_by_source': 2}`
...
- `understanding-motivations.hidden-driver-hypothesis-test`: shortest quote `31` chars across `5` quote(s)
