# Model Affordance Quality Report v8
...
- authenticity, boundaries, hanlons-razor, international-negotiation-and-diplomacy-models, persuasion-principles, reciprocity-principle, signaling, understanding-motivations: `{'explicit': 4, 'not_supported_by_source': 2}`
...
Median affordance-level source quote length: `129` characters.
