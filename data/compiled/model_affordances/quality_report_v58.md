# Model Affordance Quality Report v58
...
- Absence record status counts:
  ...
  - `duplicate_of_existing_field`: `91`
  - `not_supported_by_source`: `550`
  - `source_too_thin`: `22`
...
- adaptation, algorithmic-thinking, auditability-traceability, authenticity, bias-blind-spot, boundaries, brainstorming, branch-solve-merge, causal-attribution-resistance, circle-of-competence, combinatorial-effects, comparative-political-systems-analysis, complexity-bias-resistance, compounding, consulting-firms-methodology, creative-destruction, critical-mass, curiosity, cybersecurity-thinking-models, dialectical-reasoning, einstellung-effect, endowment-effect, extreme-performance-evaluation, gestalt-principles-of-perception, goal-setting, habit-formation, hanlons-razor, hindsight-bias, lateral-thinking, multicultural-team-dynamics, non-linear-dynamics, persistence-grit, peter-principle, power-laws, prospect-theory, rationalization, reframing-perspective, regret-theory, regulatory-horizon-scanning, scale-economies, self-control, self-determination-theory, simplification, specialization, supply-and-demand, synthesis-and-integration, system-1, tier-2-high-value, time-tested-validation, tipping-points, tradition-vs-innovation-balance, variation-and-selection, varied-practice-interleaving: `{'explicit': 4, 'not_supported_by_source': 2}`
- blooms-taxonomy, butterfly-effect, cognitive-load-theory, deliberate-practice, desirable-difficulties, elasticity, feynman-technique, generation-effect, input-vs-output-goals, internal-locus-of-control, schema-acquisition, self-organization-and-emergent-order, wysiati, zone-of-development: `{'explicit': 4, 'not_supported_by_source': 3}`
...
- conjunction-fallacy, meta-cognitive-reflection, risk-vs-uncertainty: `{'explicit': 4, 'not_supported_by_source': 8}`
...
- information-theory, usability-heuristics: `{'explicit': 4, 'not_supported_by_source': 6}`
